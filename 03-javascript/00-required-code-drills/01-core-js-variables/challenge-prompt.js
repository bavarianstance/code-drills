...
//
let statementOne = "Programmers: Ada Lovelace is a British Computer Programmer born in 1815."
...
console.log("Programmers: " + firstName + lastName + " is a " + nationality + profession + " born in " + birthYear);
...
//
let statementTwo = "She is commonly referred to as the first computer programmer"
// Use the `knownFor` variable instead of hard coding in the full string
// much like you did for the console logs and `fullName`
console.log("She is commonly referred to as the " + knownFor);
...
//
let statementThree = "In 1842 she published the first Algorithm, the Analytical Engine, at the age of 27."
// Use the `yearOfPublish`, `firstAlgorithm`, and `ageAtYearOfPublish` variables instead of hard coding in the full string
// much like you did for the console logs and `fullName`
console.log("In " + yearOfPublish + " she published the first Algorithm, " + firstAlgorithm + " , at the age of " + ageAtYearOfPublish);
...
//
let statementFour = "She was a British Citizen who lived in London, England until her passing in 1852 at the age of 37";
// Use the `nationality`, `cityLocation`, `countryLocation`, and `ageAtPassing` variables instead of hard coding in the full string
// much like you did for the console logs and `fullName`
console.log("She was a " + nationality + " Citizen who lived in " + cityLocation + " , " + countryLocation + " until her passing in " + deathYear + " at the age of " + ageAtPassing);
